<!DOCTYPE html>
<head>
<title>ShikoShop-Admin | Login </title>
...
<div class="w3layouts-main">
	<h2>Đăng Nhập</h2>
	<!-- //Thông báo đăng nhập-->
	<!-- //Nếu đăng nhập sai(message = true), hiện thông báo và ko cho bật thông báo lần nữa-->
	<?php
	...
	?>
	<!--//Tạo biến trong form action để xử lý dữ liệu-->
