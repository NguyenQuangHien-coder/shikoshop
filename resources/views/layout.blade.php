...
<head>
    ...
    <title>Trang Chủ | ShikoShop</title>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">								
								...
								{{-- Nút Đăng nhập - Đăng Xuất cho khách vãng lai và user --}}
								<?php
									$customer_id = Session::get('customer_id');
									if($customer_id != NULL) {							
								?>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1><span>SHIKO</span>-SHOP</h1>
									<h2>Sản Phẩm Chất Lượng, Mức Giá Ưu Đãi </h2>
	...
	<section>
		<div class="container">
			<div class="row">
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							{{-- Biến $category được đặt trong HomeController.php--}}
								<div class="panel panel-default">
								<div class="panel-heading">
						...
						<div class="brands_products"><!--brands_products-->
							...
							{{-- Biến $brand được đặt trong HomeController.php--}}
						...
						{{-- <div class="price-range"><!--price-range-->
							...
							<div class="well text-center">
								 ...
								 <b class="pull-left">Từ 0 đến</b> <b class="pull-right">10.000.000 VNĐ</b>
							</div>
						</div><!--/price-range--> --}}
				...
				{{-- Phần nội dung lấy từ home.blade.php			 --}}
					@yield('content')
				</div>
			</div>
		</div>
